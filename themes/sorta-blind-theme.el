...
(custom-theme-set-faces
 'sorta-blind
 '(default ((t (:inherit nil :background "gray90" :foreground "#000000" :width normal :foundry "apple" :family "Inconsolata"))))
 ...
 '(highlight ((t (:background "gray95" :foreground nil))))
 ...
 '(font-lock-function-name-face ((t (:foreground "#0d27b5" :weight bold))))
 '(font-lock-keyword-face ((t (:foreground "#033"))))
 ...
 '(font-lock-variable-name-face ((t (:foreground "#0d27b5" :weight bold))))
 ...
 '(region ((t (:background "pale green" :foreground nil))))
 '(indent-guide-face ((t (:foreground "#aaaaaa"))))
 '(query-replace ((t (:inherit isearch))))
 '(org-done ((t (:foreground "DarkGreen" :weight bold))))
 '(org-tag ((t (:foreground "gray50" :weight bold))))
 '(org-todo ((t (:background "Yellow" :foreground "Black" :weight bold))))
 '(aw-leading-char-face ((t (:background "black" :foreground "yellow" :weight bold :height 2.0))))
 '(ag-hit-face ((t (:foreground "blue"))))
