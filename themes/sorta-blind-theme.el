...
(custom-theme-set-faces
 'sorta-blind
 '(default ((t (:inherit nil :background "gray82" :foreground "#000000" :width normal :foundry "apple" :family "Monaco"))))
 ...
 '(font-lock-doc-face ((t (:inherit font-lock-string-face :underline t))))
